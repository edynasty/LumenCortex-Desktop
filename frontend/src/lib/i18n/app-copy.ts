...
export const copy = {
  "zh-CN": {
    ...
    readOnly: "只读",
    readOnlyDescription: "可读取项目并执行不修改文件的工具",
    workspace: "工作区",
    workspaceDescription: "可修改当前项目文件并运行项目命令",
    full: "完全访问",
    fullDescription: "允许更广泛的工具操作；高影响动作仍需显式确认",
    runtime: "运行时",
    workingMemory: "工作内存",
    softBudget: "软限制",
    hardBudget: "硬限制",
    ...
    permissionsTab: "权限",
    permissions: "工具权限",
    permissionsDescription: "控制当前项目中 Agent 可以看到和调用的工具。禁用项会从模型工具列表中移除，并在伪造调用时被拒绝。",
    permissionsBuiltIn: "内置工具",
    permissionsLanguage: "语言服务",
    permissionsSubagents: "子 Agent",
    permissionsMCP: "MCP 工具",
    permissionsOther: "其他已禁用工具",
    permissionsEmpty: "当前没有可管理的工具。",
    skills: "Skills",
    skillAdd: "添加 Skill",
  ...
  en: {
    ...
    missingProviderKey: "Missing key",
    ...
    readOnly: "Read only",
    readOnlyDescription: "Inspect the project and use non-mutating tools",
    workspace: "Workspace",
    workspaceDescription: "Edit project files and run project commands",
    full: "Full access",
    fullDescription: "Broader tool access; high-impact actions still require explicit approval",
    runtime: "Runtime",
    ...
    permissionsDescription: "Control which tools the agent can see and call in this project. Disabled tools are removed from model tool lists and rejected if called anyway.",
    ...
    permissionsOther: "Other disabled tools",
    permissionsEmpty: "No manageable tools are available.",
    skills: "Skills",
    skillAdd: "Add skill",
